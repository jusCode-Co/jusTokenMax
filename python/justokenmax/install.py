...
_AGENTS = {
    ...
    "omp": {
        # Pi / oh-my-pi (the `omp` binary) — user-level MCP config. Each server
        # entry is the documented {type: "stdio", command, args} shape.
        "path": "~/.omp/agent/mcp.json", "fmt": "json",
        "root": "mcpServers",
        "entry": {"type": "stdio", "command": "npx", "args": _NPX_ARGS},
    },
}
